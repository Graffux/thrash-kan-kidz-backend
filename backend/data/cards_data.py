...
INITIAL_CARDS = [
    ...
    # ---- Prophetic / James Sparks (Card A) — base card ----
    {
        "id": "card_james_sparks",
        "name": "James Sparks",
        "description": "James Sparks is the shock-slinging prophet of Prophetic, throwing stage sparks like he was wired directly into the pit. Every riff crackles, every breakdown flashes, and every crowd chant sounds like thunder trapped in a busted amp. Signature Move: Voltage Vision — predicts the next pit eruption one second before it happens.",
        "rarity": "common",
    ...
    # ---- Drooping / Rank Reekley (Card A) ----
    {
        ...
        "name": "Rank Reekley",
        "description": "Rank Reekley is the rotten stench machine of Drooping. Every note leaks like a busted sewer pipe, and every breakdown smells worse than the last. Signature Move: Reek Release — clears the pit with one toxic blast.",
        "rarity": "common",
    ...
    # ---- Drooping / Mr. Beakly (Card B) ----
    {
        "id": "card_mr_beakly",
        "name": "Mr. Beakly",
        "description": "Mr. Beakly pecks through Drooping’s riffs with bird-brained brutality. His shrieks split amps, crack eggs, and send the front row flapping backward. Signature Move: Beak Beatdown — rapid-fire pecks timed perfectly to the breakdown.",
        "rarity": "common",
